...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Add Cutomer</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Add Cutomer</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-12 col-md-">
            <div class="card custom-card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Add Cutomer</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('store-customer') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="form-group">
                                ...
                                <img id="show_image" src="{{ asset('uploads/No-Image-Placeholder.svg.png') }}"
